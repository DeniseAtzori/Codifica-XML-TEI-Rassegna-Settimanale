...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                <main>
                    ...
                    <div id="contenitoreArt">
                        ...
                        <!-- Un div per oggni coppia articolo+immagini, generato come sopra con un apply-templates, da scrivere -->
                         <!-- per ora: di ogni articolo prende titolo e testo. Ho usato il template qui sotto che è lo stesso che viene usato all'inizio-->
                         <xsl:for-each select="/tei:TEI//tei:div[@type='article']">
                            <div class="art">
                                ...
                                <xsl:value-of select="./tei:div[@type='textarticle']/tei:head"/>
                                <!-- Selezione del volume al quale appartiene -->
                                <p><xsl:value-of select="tei:div[@type='intestazione']"/></p>
                            </div>
                            <xsl:apply-templates select="./tei:div[@type='textarticle']"/>
                         </xsl:for-each>
                         <!-- qui per ora stampo tutte le immagini
                          da fare: capire come assegnare le colonne giuste -->
    ...
    <!-- estrae i testi -->
    <xsl:template match="/tei:TEI//tei:div[@type='textarticle']">
